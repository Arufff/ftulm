          ...
          <div class="card">
            <div class="card-body">
              <div class="text-center mb-5">
                ...
                <img src="<?= base_url() ?>assets/dashboard/images/kuisioner/1.png"/>
              </div>
              <form method="post" action="<?= base_url('kuisioner/create') ?>">
                <fieldset disabled>
                  <div class="mb-3">
                    <label class="form-label"><b>Nama Lengkap <span class="text-danger">*</span></b></label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?= $nama; ?>" name="nama">
                  </div>
                  <div class="mb-3">
                    <label class="form-label"><b>NIM <span class="text-danger">*</span></b></label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?= $nim; ?>" name="nim">
                  </div>
                  <div class="mb-3">
                    <label class="form-label"><b>Program Studi <span class="text-danger">*</span></b></label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?= $prodi; ?>" name="prodi">
                  </div>
                  <div class="mb-3">
                    <label class="form-label"><b>No. Handphone <span class="text-danger">*</span></b></label>
                    <input type="text" id="disabledTextInput" class="form-control" value="<?= $nohp; ?>" name="nohp">
                  </div>
                </fieldset>
                <div class="mb-3">
                  <label class="form-label"><b>Semester <span class="text-danger">*</span></b></label>
                  ...
                  <?= form_error('semester', '<p class="text-danger small ml-3">') ?>
                </div>
                <div class="mb-3">
                  <label class="form-label"><b>Tahun Akademik <span class="text-danger">*</span></b></label>
                  <select name="thnakademik" class="form-control">
                  ...
                  <?= form_error('thnakademik', '<p class="text-danger small ml-3">') ?>
                </div>
                <div class="mb-3">
                  <label class="form-label"><b>Domisili <span class="text-danger">*</span></b></label>
                  <input type="text" class="form-control" placeholder="Domisili" name="domisili">
                  <?= form_error('domisili', '<p class="text-danger small ml-3">') ?>
                </div>
